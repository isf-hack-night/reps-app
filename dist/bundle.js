...
var US_STATE = exports.US_STATE = 'ca';

// state center lat/lng
var STATE_CENTER = exports.STATE_CENTER = [37.2719, -119.2702];

// state boundaries
var STATE_BOUNDS = exports.STATE_BOUNDS = [[32.5343, -124.4096], [42.0095, -114.1308]];

// amplify team base url
var AMPLIFY_URL_BASE = exports.AMPLIFY_URL_BASE = 'https://civictools.appspot-preview.com/api/v1/actions?teamId=-Kr2PPG5GTkR3oFfQ_Lq&state=' + US_STATE;

// image sources
var CAP_PIC = exports.CAP_PIC = 'https://nerdist.com/wp-content/uploads/2016/05/20160506_nerdistnews_capexclusive_1x1.jpg';

// actions display nums
// number of actions to show on initial actions display list load
var ACTIONS_DISPLAY_LIMIT = exports.ACTIONS_DISPLAY_LIMIT = 3;
// number of additional actions to display on "load more" click
var ACTIONS_DISPLAY_INCREMENT = exports.ACTIONS_DISPLAY_INCREMENT = 10;

// potential url params to parse out of the url
var PARAM_TYPES = exports.PARAM_TYPES = ['lat', 'lng', 'actionId', 'districtLower', 'districtUpper'];
...
var COLORS = exports.COLORS = {
  ...
  // consistent copy
};var DATA_FINE_PRINT = exports.DATA_FINE_PRINT = 'We do not retain any personal data, including your address.';
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__BrowserRouter__ = __webpack_require__(27);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__Redirect__ = __webpack_require__(49);
...
function getParamData(params) {
  ...
  if (paramsArr && paramsArr.length) {
    paramsObj = paramsArr.reduce(function (memo, param) {
      _constants.PARAM_TYPES.forEach(function (type) {
...
function buildQuery(paramsObj) {
  var queryParams = Object.keys(paramsObj).map(function (key, index) {
    var firstChar = index === 0 ? '?' : '&';
    return '' + firstChar + key + '=' + paramsObj[key];
  });

  return [_constants.ROOT_PATH].concat(queryParams).join('');
}
...
var Router = function (_React$Component) {
  ...
  Router.prototype.componentWillMount = function componentWillMount() {
    ...
    __WEBPACK_IMPORTED_MODULE_1_invariant___default()(children == null || __WEBPACK_IMPORTED_MODULE_2_react__["a" /* default */].Children.count(children) === 1, 'A <Router> may have only one child element');
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__matchPath__ = __webpack_require__(17);
var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };
...
function amplify() {
  ...
  function get(districtLower, districtUpper) {
    var numLower = districtLower.match(/\d+/g)[0];
    var numUpper = districtUpper.match(/\d+/g)[0];
    var url = _constants.AMPLIFY_URL_BASE + '&stateSenateDistrict=' + numUpper + '&stateHouseDistrict=' + numLower;
...
function parseTeleNum(numStr) {
  var digits = numStr.match(/\d+/g);
  var properNum = digits && Array.isArray(digits) && digits.length && digits.join('');
  return properNum;
}
...
var _query_api = __webpack_require__(9);

var _query_api2 = _interopRequireDefault(_query_api);
...
var Autocomplete = function (_Component) {
  ...
  function Autocomplete(props) {
    ...
    _this.getPlace = _this.getPlace.bind(_this);
  ...
  _createClass(Autocomplete, [{
    ...
    value: function geolocate() {
      ...
      if (navigator.geolocation) {
        navigator.geolocation.getCurrentPosition(function (position) {
          ...
          _this2.state.autocomplete.setBounds(circle.getBounds());
        });
      }
    }
  }, {
    ...
    key: 'updateRoute',
    value: function updateRoute(lat, lng) {
      var districtsData = this.props.stateDistricts.findDistrictsForPoint(lat, lng);
      console.log('response: ', districtsData);
      var lowerId = districtsData.lower.id;
      var upperId = districtsData.upper.id;
      var newRoute = _query_api2.default.build({
        lat: lat,
        lng: lng,
    ...
    value: function componentDidMount() {
      ...
      /** @type {!HTMLInputElement} */document.getElementById(this.state.uuid), { types: ['geocode'] });

      autocomplete.addListener('place_changed', this.getPlace);

      var newState = Object.assign({}, this.state, { autocomplete: autocomplete });
...
var AutocompleteContainer = (0, _reactRouterDom.withRouter)(function (_ref) {
  var history = _ref.history,
      stateDistricts = _ref.stateDistricts;
  return (0, _preact.h)(Autocomplete, { history: history, stateDistricts: stateDistricts });
});
...
var _landing_app = __webpack_require__(56);

var _landing_app2 = _interopRequireDefault(_landing_app);
...
var RepsApp = function RepsApp() {
  return (0, _preact.h)(
    ...
    (0, _preact.h)(
      'div',
      null,
      (0, _preact.h)(_reactRouterDom.Route, { exact: true, path: _constants.ROOT_PATH, component: _landing_app2.default })
    )
  );
};
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_prop_types__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_prop_types___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_prop_types__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_history_createMemoryHistory__ = __webpack_require__(35);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_prop_types__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_prop_types___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_prop_types__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_history_PathUtils__ = __webpack_require__(8);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_prop_types__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_prop_types___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_prop_types__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_history_createHashHistory__ = __webpack_require__(45);
...
var _action_page = __webpack_require__(59);

var _action_page2 = _interopRequireDefault(_action_page);

var _cta_banner = __webpack_require__(62);

var _cta_banner2 = _interopRequireDefault(_cta_banner);

var _map_wrapper = __webpack_require__(63);

var _map_wrapper2 = _interopRequireDefault(_map_wrapper);

var _map_header = __webpack_require__(64);

var _map_header2 = _interopRequireDefault(_map_header);

var _reps_wrapper = __webpack_require__(65);

var _reps_wrapper2 = _interopRequireDefault(_reps_wrapper);
...
var _openstates = __webpack_require__(70);

var _openstates2 = _interopRequireDefault(_openstates);
...
var LandingApp = function (_Component) {
  _inherits(LandingApp, _Component);

  function LandingApp() {
    _classCallCheck(this, LandingApp);

    return _possibleConstructorReturn(this, (LandingApp.__proto__ || Object.getPrototypeOf(LandingApp)).apply(this, arguments));
  }

  _createClass(LandingApp, [{
    key: 'render',
    value: function render() {
      var paramsData = _query_api2.default.parse();
      var locOpenStates = new _openstates2.default.LocalOpenStates();
      ...
      var districts = locOpenStates.getDistricts(_constants.US_STATE);
      console.log('districts: ', districts);
      var stateDistricts = new _openstates2.default.DistrictList(districts, _constants.US_STATE, locOpenStates);
      stateDistricts.preloadDistricts();
      var display = void 0;
      var shouldDisplayAction = paramsData && paramsData.actionId;
      var shouldDisplayRepsAndActions = paramsData;
      if (shouldDisplayAction) {
        // TODO: add action display page
        display = (0, _preact.h)(
          'div',
          { className: 'Display' },
          (0, _preact.h)(_action_page2.default, paramsData)
        );
      } else if (shouldDisplayRepsAndActions) {
        display = (0, _preact.h)(
          'div',
          { className: 'Display' },
          (0, _preact.h)(_reps_wrapper2.default, paramsData)
        );
      } else {
        display = (0, _preact.h)(
          'div',
          { className: 'Display' },
          (0, _preact.h)(_cta_banner2.default, null),
          (0, _preact.h)(
            'h4',
            null,
            'Enter your address below to find actions from your CA state legislators:'
          ),
          (0, _preact.h)(_autocomplete2.default, { stateDistricts: stateDistricts }),
          (0, _preact.h)(
            'h5',
            null,
            _constants.DATA_FINE_PRINT
          )
        );
      }
      ...
      return (0, _preact.h)(
        ...
        (0, _preact.h)(
          ...
          (0, _preact.h)(_map_header2.default, { stateDistricts: stateDistricts }),
          (0, _preact.h)(_map2.default, { stateDistricts: stateDistricts, paramsData: paramsData })
        ),
        display
      );
    }
...
var JustMap = function (_Component) {
  _inherits(JustMap, _Component);

  function JustMap(props) {
    _classCallCheck(this, JustMap);

    var _this = _possibleConstructorReturn(this, (JustMap.__proto__ || Object.getPrototypeOf(JustMap)).call(this, props));
  ...
  _createClass(JustMap, [{
    ...
    value: function resetMap() {
      ...
      this.state.map.flyToBounds(_constants.STATE_BOUNDS);
    ...
    key: 'positionSet',
    value: function positionSet(lat, lng) {
      this.state.markers.clearLayers();
      ...
      var districtData = this.props.stateDistricts.findDistrictsForPoint(lat, lng);
    ...
    key: 'zoomDistrict',
    value: function zoomDistrict(districtData) {
    ...
    key: 'drawDistrict',
    value: function drawDistrict(district, districtColor) {
      var shape = [];
      ...
      for (var i = 0; i < shape.length; i++) {
        var boundary = shape[i][0].slice(1).map(function (x) {
          return [x[1], x[0]];
        }); //assumes no donuts
        shape[i] = boundary;
      }
    ...
    value: function componentDidMount() {
      // aka init map
      L.mapbox.accessToken = _KEYS2.default.mapbox;
      var map = L.mapbox.map('map', 'mapbox.light');
      map.fitBounds(_constants.STATE_BOUNDS);

      var markers = L.featureGroup();
      map.addLayer(markers);

      var myDistricts = L.layerGroup();
      map.addLayer(myDistricts);

      map.on('click', this.handleClick);

      var newState = { map: map, markers: markers, myDistricts: myDistricts
    ...
    value: function componentDidUpdate(prevProps) {
      var _props$paramsData = this.props.paramsData,
          lat = _props$paramsData.lat,
          lng = _props$paramsData.lng;
    ...
    value: function render() {
      ...
      return (0, _preact.h)('div', { style: styles, id: 'map' });
    }
  }]);
...
var Map = (0, _reactRouterDom.withRouter)(function (_ref) {
  var history = _ref.history,
      stateDistricts = _ref.stateDistricts,
      paramsData = _ref.paramsData;
  return (0, _preact.h)(JustMap, { history: history, stateDistricts: stateDistricts, paramsData: paramsData });
});
...
var API_KEYS = {
  googleMaps: 'AIzaSyCqa6NdAoaxGpKwX2g5W93Il7v8_swu7fs',
  mapbox: 'pk.eyJ1Ijoid29sZmdhbmctbXB6IiwiYSI6ImNqNXcxYXA1djA4NzIyd29ncmFzbmowZjUifQ.d_D9DGVm9sfiEJilUmR0dw'
};

exports.default = API_KEYS;
...
var _amplify = __webpack_require__(22);

var _amplify2 = _interopRequireDefault(_amplify);

var _action_info = __webpack_require__(60);

var _action_info2 = _interopRequireDefault(_action_info);
...
var ActionPage = function (_Component) {
  _inherits(ActionPage, _Component);

  function ActionPage(props) {
    _classCallCheck(this, ActionPage);

    var _this = _possibleConstructorReturn(this, (ActionPage.__proto__ || Object.getPrototypeOf(ActionPage)).call(this, props));

    _this.state = {
      isLoading: true
    };

    _this.makeAmplifyRequestAndUpdate();
    return _this;
  }

  _createClass(ActionPage, [{
    key: 'makeAmplifyRequestAndUpdate',
    value: function makeAmplifyRequestAndUpdate() {
      var _this2 = this;

      var _props = this.props,
          districtLower = _props.districtLower,
          districtUpper = _props.districtUpper;

      (0, _amplify2.default)().get(districtLower, districtUpper).then(function (response, outcome) {
        var stateUpdates = {
        ...
        var newState = Object.assign({}, _this2.state, stateUpdates);
    ...
    key: 'hasNewDistrictProps',
    value: function hasNewDistrictProps(prevProps) {
      var _props2 = this.props,
          districtLower = _props2.districtLower,
          districtUpper = _props2.districtUpper;
    ...
    value: function render() {
      if (!this.state.isLoading && this.state.successfulResponse) {
        var _queryAPI$parse = _query_api2.default.parse(),
            actionId = _queryAPI$parse.actionId;

        var action = this.state.ampData.find(function (action) {
          return action.id === actionId;
        });
        return action ? (0, _preact.h)(_action_info2.default, action) : (0, _preact.h)(
          'h4',
          null,
          'Something broke. Sad! Try refreshing the page.'
        );
      } else if (this.state.isLoading) {
        //TODO: better spinny gif
        return (0, _preact.h)('img', { src: 'https://static.fjcdn.com/gifs/Awesome_13a9db_5343455.gif', style: 'width: 75px;' });
      } else {
        return (0, _preact.h)(
          'h4',
          null,
...
var _phone_link = __webpack_require__(61);

var _phone_link2 = _interopRequireDefault(_phone_link);
...
var ActionInfo = function (_Component) {
  ...
  function ActionInfo() {
    ...
    return _possibleConstructorReturn(this, (ActionInfo.__proto__ || Object.getPrototypeOf(ActionInfo)).apply(this, arguments));
  }
  ...
  _createClass(ActionInfo, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          callScriptMd = _props.callScriptMd,
          callBackgroundMd = _props.callBackgroundMd;

      console.log('callBackgroundMd: ', callBackgroundMd);
      console.log('split? ', callBackgroundMd.split('\n'));
      var callBackgroundParagraphs = callBackgroundMd.split('\n').filter(function (para) {
        return para.length;
      }).map(function (para) {
        return (0, _preact.h)(
          'p',
      ...
      return (0, _preact.h)(
        ...
        (0, _preact.h)(
          'h3',
          { className: 'ActionInfo-header' },
          preTitle,
          ' ',
          title
        ),
        (0, _preact.h)(_phone_link2.default, { num: person.offices[0].phone }),
        (0, _preact.h)(
          'h4',
          { className: 'ActionInfo-subheader' },
          'Call script'
        ),
        (0, _preact.h)(
          'p',
...
var PhoneLink = function (_Component) {
  _inherits(PhoneLink, _Component);

  function PhoneLink() {
    _classCallCheck(this, PhoneLink);

    return _possibleConstructorReturn(this, (PhoneLink.__proto__ || Object.getPrototypeOf(PhoneLink)).apply(this, arguments));
  }

  _createClass(PhoneLink, [{
    key: 'render',
    value: function render() {
      var teleNum = _utils2.default.parseTeleNum(this.props.num);
      if (!teleNum) {
        return;
      }
      var action = _utils2.default.isOnMobile() ? 'callto:' + teleNum : 'tel:' + teleNum;

      return (0, _preact.h)(
        'a',
        { className: 'PhoneLink', href: action },
        this.props.num
      );
    }
  }]);
...
var CTABanner = function (_Component) {
  _inherits(CTABanner, _Component);

  function CTABanner() {
    _classCallCheck(this, CTABanner);

    return _possibleConstructorReturn(this, (CTABanner.__proto__ || Object.getPrototypeOf(CTABanner)).apply(this, arguments));
  }

  _createClass(CTABanner, [{
    key: 'render',
    value: function render() {
      var display = this.props.isVisible ? 'block' : 'none';

      return (0, _preact.h)(
        'div',
        { className: 'CTABanner', styles: 'display: ' + display + ';' },
        (0, _preact.h)(
          'p',
          null,
          (0, _preact.h)(
            'span',
            { className: 'CTABanner-big_text' },
            'California'
          ),
        ...
        (0, _preact.h)(
          'p',
          null,
          'As we lead the country in resisting the Trump agenda and promoting ',
          (0, _preact.h)(
            'span',
            { className: 'CTABanner-bold_text' },
            'progressive'
          ),
          ' policy, the nation will follow.'
        )
      );
    }
  }]);
...
var MapWrapper = function (_Component) {
  ...
  function MapWrapper() {
    ...
    return _possibleConstructorReturn(this, (MapWrapper.__proto__ || Object.getPrototypeOf(MapWrapper)).apply(this, arguments));
  }
  ...
  _createClass(MapWrapper, [{
    ...
    value: function render() {
      ...
      var children = this.props.children.map(function (child) {
        var isHeader = child.nodeName.name === 'MapHeader';
        console.log('mapwrapper params: ', _this2.props.paramsData);
        var shouldntShowHeader = _this2.props.paramsData === undefined;
...
var MapHeader = function (_Component) {
  _inherits(MapHeader, _Component);

  function MapHeader() {
    _classCallCheck(this, MapHeader);

    return _possibleConstructorReturn(this, (MapHeader.__proto__ || Object.getPrototypeOf(MapHeader)).apply(this, arguments));
  }
  ...
  _createClass(MapHeader, [{
    ...
    value: function render() {
      return (0, _preact.h)(
        ...
        (0, _preact.h)(
          'div',
          { className: 'MapHeader-left' },
          (0, _preact.h)(
            'h5',
            null,
            'Change address:'
          ),
          (0, _preact.h)(_autocomplete2.default, { stateDistricts: this.props.stateDistricts }),
          (0, _preact.h)(
            'h6',
            null,
            _constants.DATA_FINE_PRINT
...
var _action_dashboard = __webpack_require__(66);

var _action_dashboard2 = _interopRequireDefault(_action_dashboard);
...
var RepsWrapper = function (_Component) {
  _inherits(RepsWrapper, _Component);

  function RepsWrapper(props) {
    _classCallCheck(this, RepsWrapper);

    var _this = _possibleConstructorReturn(this, (RepsWrapper.__proto__ || Object.getPrototypeOf(RepsWrapper)).call(this, props));
    ...
    value: function render() {
      ...
      if (!this.state.isLoading && this.state.successfulResponse) {
        var _state = this.state,
            ampData = _state.ampData,
            districtLower = _state.districtLower,
            districtUpper = _state.districtUpper;

        return (0, _preact.h)(_action_dashboard2.default, { ampData: ampData, districtLower: districtLower, districtUpper: districtUpper });
      } else if (this.state.isLoading) {
        //TODO: better spinny gif
        return (0, _preact.h)('img', { src: 'https://static.fjcdn.com/gifs/Awesome_13a9db_5343455.gif', style: 'width: 75px;' });
      } else {
...
var _reps_card = __webpack_require__(67);

var _reps_card2 = _interopRequireDefault(_reps_card);

var _actions_display = __webpack_require__(68);

var _actions_display2 = _interopRequireDefault(_actions_display);
...
var ActionDashboard = function (_Component) {
  ...
  function ActionDashboard() {
    ...
    return _possibleConstructorReturn(this, (ActionDashboard.__proto__ || Object.getPrototypeOf(ActionDashboard)).apply(this, arguments));
  }

  _createClass(ActionDashboard, [{
    key: 'testAction',
    value: function testAction(person, chamber, district) {
    ...
    value: function render() {
      ...
      var numLower = this.props.districtLower.match(/\d+/g)[0];
      var numUpper = this.props.districtUpper.match(/\d+/g)[0];

      //TODO: consider making 'S' and 'H' constants... possibly connected to testAction as util function?
      var upperRep = this.props.ampData.find(function (action) {
        return _this2.testAction(action.person, 'S', numUpper);
      }) || {};
      var lowerRep = this.props.ampData.find(function (action) {
        return _this2.testAction(action.person, 'H', numLower);
      }) || {};
      ...
      return (0, _preact.h)(
        'div',
        { className: 'ActionDashboard' },
        (0, _preact.h)(
          'div',
          { className: 'RepsDisplay' },
          (0, _preact.h)(_reps_card2.default, { rep: upperRep }),
          (0, _preact.h)(_reps_card2.default, { rep: lowerRep })
        ),
        (0, _preact.h)(_actions_display2.default, { actions: this.props.ampData })
      );
    }
  }]);
...
var RepsCardBase = function (_Component) {
  _inherits(RepsCardBase, _Component);

  function RepsCardBase() {
    _classCallCheck(this, RepsCardBase);

    return _possibleConstructorReturn(this, (RepsCardBase.__proto__ || Object.getPrototypeOf(RepsCardBase)).apply(this, arguments));
  }

  _createClass(RepsCardBase, [{
    key: 'render',
    value: function render() {
      var rep = this.props.rep.person;
      if (!rep) {
        return;
      }

      var houseTitle = rep.chamber === 'H' ? 'State Assemblymember' : 'State Senator';
      var partyColor = rep.partyCode === 'D' ? _constants.COLORS.TEXT.BLUE : _constants.COLORS.TEXT.RED;
      return (0, _preact.h)(
        'div',
        { className: 'RepsCard', onClick: this.props.goToRepPage },
        (0, _preact.h)(
          'h5',
          null,
          'Your ',
        ...
        (0, _preact.h)(
          'div',
          null,
          (0, _preact.h)('img', { src: _constants.CAP_PIC }),
          (0, _preact.h)(
            'div',
            { className: 'RepsCard-info' },
            (0, _preact.h)(
              'p',
              null,
              rep.prefix,
...
var RepsCard = (0, _reactRouterDom.withRouter)(function (_ref) {
  var history = _ref.history,
      rep = _ref.rep;
  return (0, _preact.h)(RepsCardBase, {
    rep: rep,
    goToRepPage: function goToRepPage() {
...
var _action_card = __webpack_require__(69);

var _action_card2 = _interopRequireDefault(_action_card);
...
var ActionsDisplay = function (_Component) {
  _inherits(ActionsDisplay, _Component);

  function ActionsDisplay(props) {
    _classCallCheck(this, ActionsDisplay);

    var _this = _possibleConstructorReturn(this, (ActionsDisplay.__proto__ || Object.getPrototypeOf(ActionsDisplay)).call(this, props));

    _this.setState({
      actionsNum: _constants.ACTIONS_DISPLAY_LIMIT
    });

    _this.loadMoreActions = _this.loadMoreActions.bind(_this);
    return _this;
  }

  _createClass(ActionsDisplay, [{
    key: 'loadMoreActions',
    value: function loadMoreActions() {
      var currentShown = this.state.actionsNum;
      var newNum = currentShown < _constants.ACTIONS_DISPLAY_INCREMENT ? _constants.ACTIONS_DISPLAY_INCREMENT : currentShown + _constants.ACTIONS_DISPLAY_INCREMENT;
      var newState = Object.assign({}, this.state, { actionsNum: newNum });
      this.setState(newState);
    }
  }, {
    key: 'render',
    value: function render() {
      var actionsList = this.props.actions.slice(0, this.state.actionsNum).map(function (action) {
        return (0, _preact.h)(_action_card2.default, { action: action });
      });

      var loadMoreButton = this.props.actions.length > this.state.actionsNum ? (0, _preact.h)(
        'button',
        {
...
exports.default = ActionsDisplay;
...
var ActionDetails = function (_Component) {
  _inherits(ActionDetails, _Component);

  function ActionDetails(props) {
    _classCallCheck(this, ActionDetails);

    var _this = _possibleConstructorReturn(this, (ActionDetails.__proto__ || Object.getPrototypeOf(ActionDetails)).call(this, props));

    _this.goToActionPage = _this.goToActionPage.bind(_this);
    return _this;
  }

  _createClass(ActionDetails, [{
    key: 'goToActionPage',
    value: function goToActionPage() {
      var _queryAPI$parse = _query_api2.default.parse(),
          lat = _queryAPI$parse.lat,
          lng = _queryAPI$parse.lng,
          districtLower = _queryAPI$parse.districtLower,
          districtUpper = _queryAPI$parse.districtUpper;

      var newRoute = _query_api2.default.build({
        lat: lat,
        lng: lng,
        districtLower: districtLower,
        districtUpper: districtUpper,
    ...
    value: function render() {
      ...
      return (0, _preact.h)(
        'div',
        { className: 'ActionCard', onClick: this.goToActionPage },
        (0, _preact.h)(
          'p',
          null,
          action.preTitle + ' ' + action.title
        )
      );
    }
  }]);
...
var ActionCard = (0, _reactRouterDom.withRouter)(function (_ref) {
  var history = _ref.history,
      action = _ref.action;
  return (0, _preact.h)(ActionDetails, { history: history, action: action });
});
...
LocalOpenStates.prototype.getDistrictsByParams = function (US_STATE, params) {
	...
	var districtLower = params.districtLower,
	    districtUpper = params.districtUpper;
...
function pointInPolygon(points, lat, lon) {
	...
	for (; i < points.length; j = i++) {
		if (points[i][1] > lat != points[j][1] > lat && lon < (points[j][0] - points[i][0]) * (lat - points[i][1]) / (points[j][1] - points[i][1]) + points[i][0]) {
			c = !c;
		}
	}
	return c;
...
var OpenStatesAPI = {
	LocalOpenStates: LocalOpenStates,
	OpenStates: OpenStates,
	District: District,
	DistrictPopulator: DistrictPopulator,
	DistrictList: DistrictList
};

exports.default = OpenStatesAPI;
